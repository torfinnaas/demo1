...
@SpringBootTest
@Transactional
public class TurRatingServiceIntegrationTest {
    ...
    @Test
    public void delete() {
        List<TurRating> tourRatings = service.lookupAll();
        service.delete(tourRatings.get(0).getTur().getId(), tourRatings.get(0).getCustomerId());
    ...
    public void createNew() {
        ...
        TurRating newTurRating = service.verifyTurRating(TOUR_ID, CUSTOMER_ID);
        assertThat(newTurRating.getTur().getId(), is(TOUR_ID));
        assertThat(newTurRating.getCustomerId(), is(CUSTOMER_ID));
        assertThat(newTurRating.getScore(), is(2));
        assertThat(newTurRating.getComment(), is ("it was fair"));
    }
    ...
    public void update() {
        createNew();
        TurRating tourRating = service.update(TOUR_ID, CUSTOMER_ID, 1, "one");
        assertThat(tourRating.getTur().getId(), is(TOUR_ID));
